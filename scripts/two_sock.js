...
// Run the test for this file with the command: npm run two_sock

/* 
  Kaelah is getting ready to go to the store. Before she can put her shoes on, she needs socks!
  Write an algorithm that takes in a collection (array) of colored socks, and return the color of
  the first sock pair that you find.
